...
import ConceptualGeralTab from './ConceptualGeralTab';
import ConceptualPropertiesTab from './ConceptualPropertiesTab';
import ConceptualSceneTab from './ConceptualSceneTab';
  ...
  objects: [
    {
      id: 1,
      name: 'Geral',
      component: ConceptualGeralTab,
    },
    {
      id: 2,
      name: 'Propriedades',
      component: ConceptualPropertiesTab,
    }
  ]
}

/**
 * Componente que representa as Tabs da Ferramenta de Modelagem Conceitual.
 */
function ConceptualTabs() {
